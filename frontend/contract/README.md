...
0. Run the build-contract.sh command from the within this directory (OPTIONAL. The next step runs this same command this is just for insight on whats going on)
